...
namespace WebBanHangOnline.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    //if (!IsInventoryAvailable(cart.Items))
                    //{
                    //    // Xử lý khi số lượng tồn kho không đủ
                    //    return Json(new { Success = false, Code = -1, Msg = "Số lượng tồn kho không đủ" });
                    //}
                    ...
                    // Gọi hàm DecreaseProductQuantity và truyền danh sách mục giỏ hàng
                    DecreaseProductQuantity(cart.Items);
        ...
        public ActionResult AddToCart(int id, int quantity)
        {
            ...
            if (checkProduct != null)
            {
                ...
                if (cart == null)
                {
                    ...
                    cart = new ShoppingCart(db); // Chuyển đối số context vào đây
        ...
        [AllowAnonymous]
        [HttpPost]
        public void DecreaseProductQuantity(List<ShoppingCartItem> cartItems)
        {
