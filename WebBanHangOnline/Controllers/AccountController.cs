...
namespace WebBanHangOnline.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Xóa giỏ hàng khi đăng nhập tài khoản
            Session["Cart"] = null;
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (!isEmailConfirmed)
                {
                    // Handle the case where the email is not confirmed
                    // For example, you might want to redirect to a page saying that the email is not confirmed.
        ...
        {
            // Xóa giỏ hàng khi thoát tài khoản
            Session["Cart"] = null;
